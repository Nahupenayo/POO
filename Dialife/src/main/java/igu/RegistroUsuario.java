...
public class RegistroUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Registro del Usuario");
    ...
    private void btnRegistrarUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarUActionPerformed
     ...
     String nombrePerso = txt1.getText();
     String apellidoPerson = txt2.getText();
     String edadPerson = txt3.getText();
     String documentoPerson = txt4.getText();
     
        
     control.registrar(nombrePerso, apellidoPerson, edadPerson, documentoPerson);
